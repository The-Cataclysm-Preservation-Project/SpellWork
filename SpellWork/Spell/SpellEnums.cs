...
namespace SpellWork.Spell
{
    ...
    public enum Targets
    {
        ...
        TARGET_UNIT_CASTER_PASSENGERS           = 105, // 1 spell
        ...
        TARGET_UNK_124                          = 124,
        TARGET_DEST_CASTER_FLOOR                = 125,
        TARGET_UNIT_AREA_ENEMY                  = 126,
        TARGET_UNK_127                          = 127,
        TOTAL_SPELL_TARGETS,
    };
    ...
    public enum SpellAtributeEx7 : uint
    {
        ...
        SPELL_ATTR7_NONE                                = 0x00000000, //  0 Shaman's new spells (Call of the ...), Feign Death.
